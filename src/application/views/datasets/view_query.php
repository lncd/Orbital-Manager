...
if (TRUE)
{
	...
	echo '<a href="' . site_url('dataset/' . $query_dataset . '/query/' . $query_name . '/edit') . '" class="btn btn-small"><i class="icon-pencil"></i> Edit</a>';
...
echo '<div class="modal fade" id="delete_query">
		...
		<div class="modal-footer">
			...
			<a href="' . site_url('dataset/' . $query_dataset . '/query/' .  $query_name . '/delete') . '" class="btn btn-danger"><i class="icon-trash"></i> Delete Query</a>
		</div>
	</div>';
